...
![Actual WSJT-X FT8 self-decode](img/sv1eex1.png)

*Original WSJT-X SelfRX capture from the working test setup, showing successful FT8 self-decodes of `CQ SV1EEX KM17` during simultaneous transmit and receive.*
...
![Actual ZynqRadio Control Center](img/sv1eex2.png)

*Original screenshot from the running ZynqRadio Control Center, showing the live RX rate, IQ/RX-audio diagnostics, CAT connection state and TX underrun counter.*
...
Κατά την ανάπτυξη χρησιμοποιήθηκαν δύο instances του WSJT-X: το πρώτο για TX και το δεύτερο ως self-receiver. Παρατηρήθηκε κανονικό FT8 decode των πλαισίων `CQ SV1EEX KM17` ενώ RX και TX λειτουργούσαν ταυτόχρονα. Οι αυθεντικές εικόνες του test setup εμφανίζονται παραπάνω στο README.
